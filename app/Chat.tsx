...
export default function Chat({ mode }: { mode: "naive" | "hyde" }) {
  ...
  const modeLabel = mode === "hyde" ? "HyDE" : "Naive";
    ...
    <div className="app">
      ...
      <header className="masthead">
        ...
        <p className="brand-sub">
          2025년 사업보고서 기준 · <span className="mode-tag">{modeLabel}</span>
        </p>
      </header>

      <div className={`thread${showEmpty ? " centered" : ""}`} ref={threadRef}>
        {showEmpty && (
          <div className="empty">
